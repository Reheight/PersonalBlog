...
<div class="m-2 flex flex-col">
    ...
    <div class="relative m-2 p-2 bg-gray-400 flex flex-row rounded-md hover:shadow border-2 border-gray-300 hover:border-gray-200 ease-in-out transform-gpu transition-all">
