...
<h1 class="m-4 font-montserrat text-2xl font-bold">Categories Panel</h1>
<div class="m-4 flex">
    <form
        action="?/create"
        method="post"
    ...
    >
        <input type="text" name="name" placeholder="Create Category" autofocus autocomplete="fuckoff"
