	...
	<div class="mb-2 md:mb-0 md:w-3/12 md:mr-2 h-fit shadow bg-orange-300 rounded-md p-2">
		<div class="flex flex-row justify-between">
			<div class="flex flex-row items-center justify-between w-full">
				<h4 class="font-robotomono uppercase font-bold text-base text-gray-800">{data.member.name}</h4>
				<h3 class="font-robotomono uppercase font-bold text-xs text-gray-700">@{data.member.username}</h3>
			</div>
		</div>
	</div>
